...
function calc_rank(hand) {
    ...
    let M = counts[0];
    if (M + jokers >= 5) return 7; 
    else if (M + jokers >= 4) return 6; 
    else if ((jokers == 1 && counts[0] == 2 && counts[1] == 2) ||
             (counts[0] == 3 && counts[1] == 2)) return 5;
    else if (M + jokers >= 3) return 4;
    else if (pairs == 2) return 3;
    else if (M + jokers >= 2) return 2;
    else return 1; 
}
